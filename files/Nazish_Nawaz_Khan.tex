...
\begin{itemize} \itemsep 1pt
	...
	\item Working on job abends (restart, adhoc run, force complete, no-op, manual hold), modifying JCL (overload/override), OPC/ESA, SDSF, WTOR, JES2, TSO/ISPF, CICS, MQ, IPL
